...
function checkSettings(menu) {
    
}

function validateInput(input, maxLen) {
    const len = input.value.length;
    console.log(len);
    if (input.value.length > maxLen || !input.value.match(/^[0-9]/)) input.value = input.value.substring(0, len - 1);
    console.log(input.value)
}

function addPomodoro(el) {
    alert("hey")
}
...
function playPomodoro(el) {

}

function pausePomodoro(el) {
    
}

function resetPomodoro(el) {
...
div.innerHTML = `
            ...
            <div class="settings-menu">
                <h2>Settings</h2>
                <div class="settings-menu-general-settings">
                    <div class="sound">
                        <span>Sound</span>
                        <input type="checkbox" name="sound-btn" id="sound-btn">
                    </div>
                </div>
                <h2>Timer</h2>
                <div class="settings-menu-timer-settings">
                    <div class="work-session">
                        <span>Время работы</span>
                        <div>
                            <input type="number" placeholder="0" name="work-session-input-hours" id="work-session-input-hours">
                            <span>ч</span>
                            <input type="number" placeholder="25" name="work-session-input-min" id="work-session-input-min">
                            <span>мин</span>
                        </div>
                    </div>
                    <div class="short-break">
                        ...
                        <div>
                            <input type="number" placeholder="0" name="short-break-input-hours" id="short-break-input-hours">
                            <span>ч</span>
                            <input type="number" placeholder="5" name="short-break-input-min" id="short-break-input-min">
                            <span>мин</span>
                        </div>
                    </div>
                    <div class="long-break">
                        ...
                        <div>
                            <input type="number" placeholder="0" name="long-break-input-hours" id="long-break-input-hours">
                            <span>ч</span>
                            <input type="number" placeholder="15" name="long-break-input-min" id="long-break-input-min">
                            <span>мин</span>
                        </div>
                    </div>
                    <div class="Pomodoro-count">
                        ...
                        <div>
                            <input type="number" name="pomodoro-count" id="pomodoro-count">
                        </div>
                    </div>
                </div>
            </div>
